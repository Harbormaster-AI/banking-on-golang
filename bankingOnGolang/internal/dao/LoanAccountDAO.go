		...
		for _, repaymentScheduleId:= range repaymentScheduleIds {
			...
			if childRequestResult == nil {
                ...
                requestResult = utils.RequestResult{
                    Success: false,
                    Message: msg,
                    Action:  "unassignRepaymentSchedule",
                    Data:    childObj,
                }
				return requestResult
			}
		...
		for _, repaymentScheduleId:= range repaymentScheduleIds {
			...
			if childRequestResult == nil {
                ...
                requestResult = utils.RequestResult{
                                    Success: false,
                                    Message: msg,
                                    Action:  "removeRepaymentSchedule",
                                    Data:    childObj,
                                }
				return requestResult
			}
